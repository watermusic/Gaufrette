...
use Gaufrette\Adapter\FreeLocal;

class FreeLocalTest extends FunctionalTestCase
{
    private $directory;
    ...
    public function setUp()
    {
        ...
        $this->filesystem = new Filesystem(new FreeLocal($this->directory, $this->host));
    }
    ...
    public function shouldWorkWithSyslink()
    {
        ...
        $this->filesystem = new Filesystem(new FreeLocal($linkname, $this->host));
    ...
    /**
     * @test
     * @covers Gaufrette\Adapter\FreeLocal
     */
     ...
     * @covers Gaufrette\Adapter\FreeLocal
     */
    public function shouldGivePublicUri() {
        ...
        $url = $this->filesystem->getAdapter()->getUrl("localDir/foo.jpg");

        $this->assertEquals($this->host . '/localDir/foo.jpg', $url);
